...
export const LocationsPage = () => {
  const locations = [
    { city: 'Lisbon', address: 'Rua Augusta 124, 1100-053 Lisboa', phone: '+351 21 345 6789', image: 'photo-1588535684923-900727736ac0.avif' },
    { city: 'Porto', address: 'Rua de Santa Catarina 312, 4000-443 Porto', phone: '+351 22 123 4567', image: 'photo-1555881400-74d7acaacd8b.avif' },
    { city: 'London', address: '15 Greek St, Soho, London W1D 4DP', phone: '+44 20 7123 4567', image: 'photo-1513635269975-59663e0ac1ad.avif' },
    { city: 'New York', address: '245 Bleecker St, New York, NY 10014', phone: '+1 212 555 0123', image: 'photo-1496442226666-8d4d0e62e6e9.avif' }
  ];
